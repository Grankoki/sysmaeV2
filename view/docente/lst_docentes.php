...
<div class="container-fluid">
    <div class="row form-group">
                                ...
                                foreach ($listaDocentes as $registro){ $i++;?>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-2 center ">
                                            <?php echo $registro->especialidad ?>
                                        </div>
                                        <div class="col-2 center ">
                                            <div class="row form-group">
                                                <div class="col-sm-1 center"><a href="?administrador=editarDocente&idDocente=<?php echo $registro->idDocente ?>"><img height="20px" src="./img/modificar.png"></a></div>
        ...
        <div class="col-1" id="div-right" style="background-color: #C0D9FF; padding-top: 200px" >
            <div class="row form-group">
                <div class="col center">
                    <a class="btn btn-primary btn-sm" href="?administrador=registrarDocente" style="color:white">Registrar Docente</a>
                </div>
            </div>
            <div class="row form-group">
