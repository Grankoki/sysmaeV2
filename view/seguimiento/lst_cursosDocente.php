                ...
                <div class="col-12" style="padding: 10px;">
                    ...
                    if($listaCursoDocente!=null){
                        foreach ($listaCursoDocente as $registro){ ?>
                            <div class="row form-group">
                                <div class="col center">
                                    <a class="nav-link nav-white" href="?seguimiento=lst_unidadesCursoDocente&idSeccion=<?php echo base64_encode($registro->idSeccion)?>
                        ...
                        <div class="row form-group">
                            <div class="col center">
                                <font face="Comic sans ms">
                                    <h1> <?php echo "Seguimiento y control del estudiante "?></h1>
                                </font>
                            </div>
                        </div>
