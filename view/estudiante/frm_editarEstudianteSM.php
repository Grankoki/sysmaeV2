...
<div class="container-fluid">
    <div class="row form-group">
        <div class="col-2" id="div-left" style="background-color: #115089; padding-top: 80px; min-height: 650px;">
            ...
            <div class="row form-group">
                <div class="col-6 center">
                    <a class="btn btn-primary btn-sm" href="?administrador=listarEstudiantesNM" style="color:white">Back</a>
                </div>
                <div class="col-6 center">
        ...
        <div class="col-9" id="div-middle" style="background-color: #E8EAFC; padding-top: 40px">
            <form method="post" action="?administrador=cmd_editarEstudianteNM" enctype='multipart/form-data'>
                <div class="row form-group">

                    <div class="container" style="background-color: #E8EAFC; padding:20px;">
                        <div class="row form-group">
                            <div class="col center">
                                <h4>ACTUALIZACIÓN DE DATOS DEL ESTUDIANTE SIN MATRICULA</h4>
                            </div>
                        </div>
                        <?php $i=0;
                                    ...
                                    <div class="row form-group">
                                        <div class="col-9">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-3">
                                                    <input type="nombres" disabled class="form-control" id="txt_password" name="txt_password" required="true" value="<?php echo $registro->password ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col-10">
        ...
        <div class="col-1" id="div-right" style="background-color: #C0D9FF; padding-top: 200px" >
            ...
            <div class="row form-group">
                <div class="col center">
                    <?php if($seccion=="sin matricula"){ ?>
                        <a class="btn btn-primary btn-sm" href="#" style="color:white">Matricular en sección</a>
                    <?php }else{ ?>
                        <a class="btn " href="#" style="color:white">Estudiante Matriculado</a>
                    <?php } ?>
                </div>
            </div>
            <div class="row form-group">
