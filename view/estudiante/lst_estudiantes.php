...
<div class="container-fluid">
    <div class="row form-group">
        <div class="col-2" id="div-left" style="background-color: #115089; padding-top: 80px; min-height: 650px;">
            ...
            <div class="row form-group">
                <div class="col-12" style="padding: 10px;">
                    <div class="row form-group">
                        <div class="col">
                            <label style="color:white">Sección</label>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col">
                            <select name="cbx_seccion" id="cbx_seccion"
                                ...
                                <?php
                                foreach ($listaSecciones as $registro){
                                    echo "<option value=".$registro->idSeccion.">".$registro->desSeccion."</option>\n";
                                } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        if($listaEstudiantes!=null){
                            foreach ($listaEstudiantes as $registro){ $i++;?>
                                <div class="row form-group">
                                    ...
                                    <div class="col-1 center ">
                                        <div class="row form-group">
                                            <div class="col-sm-1 center"><a href="?administrador=editarEstudiante&idEstudiante=<?php echo $registro->idEstudiante ?>&seccion=<?php echo $registro->seccion ?>&apoderado=<?php echo $registro->apoderado ?>"><img height="20px" src="./img/modificar.png"></a></div>
        ...
        <div class="col-1" id="div-right" style="background-color: #C0D9FF; padding-top: 200px" >
            ...
            <div class="row form-group">
                <div class="col center">
                    <a class="btn btn-primary btn-sm" href="?administrador=listarEstudiantesGeneral" style="color:white">Lista General</a>
                </div>
            </div>
            <div class="row form-group">
                <div class="col center">
                    <a class="btn btn-primary btn-sm" href="?administrador=listarEstudiantesInactivos" style="color:white">Alumnos sin matricula</a>
                </div>
            </div>
            <div class="row form-group">
                <div class="col center">
