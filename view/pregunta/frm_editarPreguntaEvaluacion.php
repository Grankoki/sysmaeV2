...
<div class="container-fluid">
    <div class="row form-group">
        ...
        <div class="col-9" id="div-middle" style="background-color: #E8EAFC; padding-top: 80px">
            <form action='?evaluacion=cmd_editarPreguntaEvaluacion' id="frmSelect" method='post'>
                <div class="row form-group">
                    <div class="col-12">
                        <br>
                        <h4>Evaluación: Actualización de Preguntas</h4>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-1 center">
                        <select name="cbx_puntajePregunta" id="cbx_puntajePregunta" class="form-control" aria-label="Default select example">
                            <?php
                            $i=1;
                            echo "<option value=".$_GET['puntaje']." selected=".$_GET['puntaje'].">".$_GET['puntaje']."</option>\n";
                            while($i<=10){
                                //
                ...
                <?php
                foreach ($datosPreguntaEvaluacion as $registro){
                ...
                <div class="row form-group center">
                    <div class="col-8">
                        <button type="submit" class="btn btn-primary btn-lm">Actualizar y Volver</button>
                    </div>
                </div>
            </form>
